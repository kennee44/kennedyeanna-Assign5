...
public class DBHelperClass extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Insert data into SQLite database.  This information is inputted from an Excel Sheet and copied and pasted over.

        String startInsert = "INSERT INTO roomList(name,city,building,floor,floorlocation,directions,imageURL,capacity,amenities,icon,spare1,spare2) ";
        ...
        db.execSQL(startInsert + "VALUES ('Mullach Ide 1','DUB','01',1,'Middle Finger','Beside Entrance','mullachíde1',2,'Phone,Video Confrencing,Whiteboard','iconURL','Spare1','Spare2') ");
        db.execSQL(startInsert + "VALUES ('Mullach Ide 2','DUB','01',1,'Left Finger','Turn Right, 15 meters, Meeting Room on Left','mullachíde2',2,'Phone,Satellite Link,Flip Charts','iconURL','Spare1','Spare2') ");
        db.execSQL(startInsert + "VALUES ('Mullach Ide 3','DUB','01',1,'Right Finger','Turn Left at Watercooler','mullachíde3',2,'Phone,Windows Conf,Flip Charts','iconURL','Spare1','Spare2') ");
        db.execSQL(startInsert + "VALUES ('Mullach Ide 4','DUB','01',1,'Middle Finger','Straight Ahead','mullachíde4',2,'Phone,Video Confrencing,Flip Charts','iconURL','Spare1','Spare2') ");
        db.execSQL(startInsert + "VALUES ('Mullach Ide 5','DUB','01',1,'Left Finger','Beside Canteen','mullachíde5',2,'Phone,Satellite Link,Flip Charts','iconURL','Spare1','Spare2') ");
